...
export default () => {
    const projectLists = [
        {
            name: "POMOTODO",
            desc: "Todo List & Pomodoro Technique.",
            link: "http://idealdestructor.github.io/todo/index.html",
            icon: "i-fluent-emoji-flat-full-moon",
        },
        {
            name: "Doraemon",
            desc: "Doraemon Search & Web Navigation.",
            link: "http://idealdestructor.github.io/Doraemon",
    ...
    const openLink = () => {
        window.open("https://github.com/idealdestructor", "_blank")
    }
    return (
        <>
